 ...
 * @author ali
 */
public class TPOStudentDetailsJframe extends javax.swing.JFrame {
    ...
    public TPOStudentDetailsJframe(Integer tpo) {
        initComponents();
        setDefaultCloseOperation(TPOStudentDetailsJframe.HIDE_ON_CLOSE);
        tpo_id = tpo;
    ...
    public ArrayList<TPOStudentDetails> getStudentList() {
        ArrayList<TPOStudentDetails> studentList = new ArrayList<TPOStudentDetails>();
        ...
        try {
            ...
            TPOStudentDetails user;
            while (rs.next()) {
                user = new TPOStudentDetails(rs.getString("fname"), rs.getInt("stu_id"), rs.getInt("FE"), rs.getInt("SE"), rs.getInt("TE"), rs.getString("username"), rs.getDate("academic_year").toString());//
    ...
    public void Show_Student_In_JTable() {
        ArrayList<TPOStudentDetails> list1 = getStudentList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TPOStudentDetailsJframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
